...
This questioned was put to me by a friend on a recent night out (pint of cider in hand) about my decision to have a dry year, which I'm nearly half way through. My initial, unconvincing response was that I'll have completed a [70.3](https://en.wikipedia.org/wiki/Ironman_70.3). To which he again queried "You couldn't have done that anyway?"

His attitude, and my weak response, got me thinking about what I'll really have after a year of no alcohol, and whether I could have had those things anyway?

I'll have 365 fresh mornings in which I've exercised, read, journaled, and worked on my goals.

I'll have developed the confidence to enjoy myself, and relax, without a drink in hand.

Clarity. So much time is spent in an intoxicated haze or the lethargy of a hangover when alcohol is part of your life 

A healthier bank balance

Had energy for my kids on the weekends, in place of

Broken the cycle 

But these things won't mean much to my friend, or the many others who have shown their disbelief (or disapproval) at my decision. And that's fine. It's taken me 22+ years to get to this point, to have the guts to go against the grain, to run in the opposite direction to the crowd. I can't expect them to.

Could I have achieved any of this whilst continuing on the same alcohol path? To an extent. To the same extent that I've achieved them in the past. Partially. In a stop start way. Maybe some of it. Maybe partially. The intent would be there. But alcohol taketh away. Alcohol delays... until tomorrow, until next week, until next month or next year. I want these things now.

You gain confidence when you read posts like Derek Sivers' [Some will always say you're wrong](https://sivers.org/wrong). It states *"You have to know your preferences well, because no matter what you do, **someone will tell you you’re wrong**"*, and then follows up with:
...
And that's the biggest thing that I'll have to show: pride in my stance, and smile on my face in the face of criticism. 
